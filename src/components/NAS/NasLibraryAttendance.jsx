          ...
          <TableContainer component={Paper} sx={{ maxHeight: 450, overflowY: 'auto', opacity: 0.95,borderRadius:'15px 15px 0 0'}}>
            <Table>
              <TableHead sx={{background: 'linear-gradient(to bottom, #D76565 20%, #BE4747 79%)', color: '#fff' }}>
                <TableRow>
                  <TableCell sx={{ fontWeight: 'bold', color: '#000',borderRight: '1px solid #ffffff', width:'80px', textAlign: 'center'}}>Profile</TableCell>
                  <TableCell sx={{ fontWeight: 'bold', color: '#000',borderRight: '1px solid #ffffff', width:'200px',textAlign: 'center'}}>Student Name</TableCell>
                  <TableCell sx={{ fontWeight: 'bold', color: '#000',borderRight: '1px solid #ffffff',textAlign: 'center'   }}>Time In</TableCell>
                  <TableCell sx={{ fontWeight: 'bold', color: '#000', borderRight: '1px solid #ffffff', textAlign: 'center'  }}>Time Out</TableCell>
                  <TableCell sx={{ fontWeight: 'bold', color: '#000', borderRight: '1px solid #ffffff', textAlign: 'center' }}>Status</TableCell>
                </TableRow>
              </TableHead>
              <TableBody>
